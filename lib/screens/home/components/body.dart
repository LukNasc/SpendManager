import 'package:SpendManager/screens/components/card_conta.dart';
import 'package:SpendManager/screens/components/card_transacao.dart';
import 'package:SpendManager/screens/transacao/transacao_screen.dart';
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            padding: EdgeInsets.only(top: 32, left: 24, bottom: 16, right: 24),
            child: Row(
